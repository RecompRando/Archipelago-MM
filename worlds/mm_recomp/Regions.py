...
region_data_table: Dict[str, MMRRegionData] = {
    ...
    "Road to Ikana": MMRRegionData(["Ikana Graveyard", "Lower Ikana Canyon"]),
    "Ikana Graveyard": MMRRegionData([]),
    "Lower Ikana Canyon": MMRRegionData(["Secret Shrine", "Upper Ikana Canyon"]),
    "Upper Ikana Canyon": MMRRegionData(["Beneath the Well", "Ikana Castle", "Stone Tower"]),
